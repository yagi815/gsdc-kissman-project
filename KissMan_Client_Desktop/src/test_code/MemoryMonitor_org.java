...
public class MemoryMonitor_org extends JPanel {
    ...
    public class Surface extends JPanel implements Runnable {
        ...
        public void run() {
            ...
            while (thread == me && isShowing()) {
                ...
                if (MemoryMonitor_org.dateStampCB.isSelected()) {
    ...
    public static void main(String s[]) {
        final MemoryMonitor_org demo = new MemoryMonitor_org();
